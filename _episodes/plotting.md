...
![Simple Position-Time Plot](../fig/simple_position_time_plot.png)
...
![GDP plot for Australia](../fig/gdp_australia.png)
## Select and transform data, then plot it.
...
![GDP plot for Australia and New Zealand](../fig/gdp_australia_nz.png)
...
![GDP barplot for Australia](../fig/gdp_bar.png)
...
![GDP formatted plot for Australia](../fig/gdp_australia_formatted.png)
...
![GDP formatted plot for Australia and New Zealand](../fig/gdp_australia_nz_formatted.png)
...
![GDP correlation using plt.scatter](../fig/gdp_correlation_plt.png)
~~~
data.T.plot.scatter(x = 'Australia', y = 'New Zealand')
~~~
{: .language-python}

![GDP correlation using data.T.plot.scatter](../fig/gdp_correlation_data.png)
> ## Minima and Maxima
>
...
> > ~~~
> > {: .language-python}
> > ![Minima Maxima Solution](../fig/minima_maxima_solution.png)
> {: .solution}
{: .challenge}
...
> > ## Solution
> >
> > ![Correlations Solution 1](../fig/correlations_solution1.png)
> >
...
> {: .language-python}
> > ## Solution
> > ![Correlations Solution 2](../fig/correlations_solution2.png)
> >
...
>
> > ## Solution
> > ![More Correlations Solution](../fig/more_correlations_solution.png)
> >
